  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-center items-center text-white">
        <div className="text-2xl font-bold bg-black/50 px-6 py-3 rounded-lg">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-6xl">
          ...
          <>
              ...
              <motion.div
                ...
                onDragEnd={(event, info) => {
                  ...
                  setTimeout(() => {
                    ...
                    if (binElement) {
                      const binType = binElement.getAttribute(
                        "data-bin-type"
                      ) as ItemType;
                      handleDrop(binType);
                    } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-8">
              <motion.div
                ...
                onMouseEnter={() =>
                  isDragging && setHoveredBin("Recyclage_matières")
                }
              ...
              <motion.div
                ...
                onMouseEnter={() =>
                  isDragging && setHoveredBin("reconditionnement")
                }
                onMouseLeave={() => setHoveredBin(null)}
                className="relative flex items-center justify-center"
                style={{ height: "300px" }}
        ...
        {(gameOver || gameWon) && (
          ...
          >
            <div className="text-8xl mb-6">{gameWon ? "🎉" : "😢"}</div>
